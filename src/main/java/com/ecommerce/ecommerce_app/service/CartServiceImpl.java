...
import com.ecommerce.ecommerce_app.repositories.CartItemRepository;
...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if (product.getQuantity() < quantity) {
            throw new APIException("Please, make an order of the " + product.getProductName() + " less than or" +
                "equal to quantity" + product.getQuantity()+ ".");
        }
    ...
    public CartDTO getCart(String emailId, Long cartId) {
        ...
        CartDTO cartDTO = modelMapper.map(cart, CartDTO.class);
        cart.getCartItems().forEach(c -> c.getProduct().setQuantity(Long.valueOf(c.getQuantity())));
        List<ProductDTO> products = cart.getCartItems().stream()
                .map(p -> modelMapper.map(p.getProduct(), ProductDTO.class))
                .toList();
        cartDTO.setProducts(products);
    ...
    public String deleteProductFromCart(Long cartId, Long productId) {
        ...
        return "Product " + cartItem.getProduct().getProductName() + " removed successfully from the cart!!! ";
    }
